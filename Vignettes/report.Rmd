...
This is the report for the semester project of the course ´Proseminar in Geocomputation and Earth Observation´ and shows an Applied Geo-Data Science project.
...
Describing data (scale, source), methods
